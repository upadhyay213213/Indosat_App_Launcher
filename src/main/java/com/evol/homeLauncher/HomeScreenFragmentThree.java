...
public class HomeScreenFragmentThree extends HomeFragment {
    ...
    public static HomeScreenFragmentThree newInstance(Activity homeActivity, int position) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.home_widget_host_fragment_layout_2, container, false);
    ...
    private void loadViews(View view) {
        mainlayout = (ViewGroup) view.findViewById(R.id.home_view_2);
